...
\textbf{Rangeify} & Determine the kernel split of the function. \\
\textbf{Optimize} & Swap and split ranges, and determine which axes are parallel and which are serial. \\
\textbf{Expand} & Expand the parallel ranges into shape, soon not \texttt{dtype.vec}. \\
...
\textbf{Register/Memory Plan} & Reuse storage for values with non-overlapping lifetimes. \\
