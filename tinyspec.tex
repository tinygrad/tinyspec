...
\op{Replicated} & $(T,)$ & axes & Mark $T$ as replicated along axes. \\
\bottomrule
\end{tabular}
...
\op{Reduce} & $\mathrm{src}[0].\mathrm{dtype}$ & collapse axes to $1$ & $\mathrm{src}[0].\mathrm{device}$ & dtype range \\
\op{Replicated} & $\mathrm{src}[0].\mathrm{dtype}$ & collapse axes to $1$ & $\mathrm{src}[0].\mathrm{device}$ & $\mathrm{src}[0]$ \\[3pt]
