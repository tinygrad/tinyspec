...
\op{Group} & $(u_0, u_1, \ldots)$ & --- & Void no-op that merges sibling dependencies into one node, often to bundle multiple \op{Store}s. It does not impose an order among the grouped sources. \\
